<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Rent Receive</h1>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?= base_url('payment/bill_payment')?>" method="post">
                            ...
                            <div class="row" style="margin-top:5px;">
                                <label class="col-sm-3 control-label"></label>
                                <button type="button" class="btn  btn-primary rent-receive-submit">Submit</button>
                            </div>
                            <div class="form-group load_receiveContent">
        ...
        <script src="<?php echo base_url();?>js/custom/rentReceive.js"></script>
    </div>
</div>
