<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Rent Generate Report</h3>
            </div>
        </div>
                ...
                <div class="panel panel-default panel-shadow" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row" style="margin-top:5px;">
                                <label class="col-sm-3 control-label"></label>
                                <button type="button" class="btn  btn-primary rent-generate-submit">Submit</button>
                            </div>
                            <div class="form-group load_GenerateReport">
        ...
        <script src="<?php echo base_url();?>js/custom/rentGenerateReport.js"></script>
    </div>
</div>
