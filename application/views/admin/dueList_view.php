<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Due List</h1>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row" style="margin-top:5px; text-align: left;">
                                <label class="col-sm-3 control-label"></label>
                                <button type="button" class="btn  btn-primary due-list-submit">Submit</button>
                            </div>
                            <div class="form-group load_dueContent">
        ...
        <script src="<?php echo base_url();?>js/custom/myDueList.js"></script>
    </div>
</div>
