            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    <h1 class="page-header">
                        ...
                        <a href="#pop2" data-hd="0" id="chat" data-id="0" class="btn btn-danger">Chart of Account</a>
                    </h1>
...
overflow: auto;">
                    ...
                    <div class="row" id="pop" style="display:none">
                        ...
                        <a href="#Popup">
                            <button style='font-family:cursive;padding:10px;font-weight:bold;back'
                                    onclick='create_ladger()' id="btn_pop" type="button">Create Ladger
                            </button>
                        </a>
                        ...
                        <a href="#Popup">
                            <button style='font-family:cursive;padding:10px;font-weight:bold;back'
                                    onclick='ladger_all()' id="ladger_all" type="button">Ladger All
                            </button>
                        </a>

                        <a href="#Popup">
                            <button style='font-family:cursive;padding:10px;font-weight:bold;back;'
                                    onclick='create_product()' id="btn_product" type="button">Create Product Ladger
                            </button>
                        </a>

                        <a href="#Popup">
                            <button style='font-family:cursive;padding:10px;font-weight:bold;back;'
                                    onclick='product_all()' id="product_all" type="button">Product All
                            </button>
                        </a>
                        ...
                        foreach ($all as $val): ?>
                            <div class="row">
                                ...
                                <div class="col-sm-3" id="<?php echo $val['id'] . "s" ?>">
                                    ...
                                    <label onclick="parent_change(<?php echo $val['id'] ?>,<?php echo $val['head'] ?>,<?php echo $val['ob'] ?>)"
                                ...
                                <div class="col-sm-2">
                                    ...
                                    if ($val['acces'] == 1) {
                                        ...
                                        <div class="col-sm-3" id="<?php echo $val['id'] . "main" ?>">
                                            ...
                                            <a onclick="edit_new(<?php echo $val['id'] ?>,'<?php echo $val['name'] ?>',<?php echo $i ?>,<?php echo $val['head'] ?>)"
                                               style="color:red;font-weight:bold" href="#"><span
                                                        id="<?php echo $val['id'] ?>">Edit</span></a>

                                        </div>
                                        <div class="col-sm-5" id="<?php echo $val['id'] . "d" ?>">

                                            <a onclick="delete_new(<?php echo $val['id'] ?>,<?php echo $val['head'] ?>)"
                                               style="color:red;font-weight:bold" href="#">X</a>
                        ...
                        <div class="content">
                            ...
                            <div id="ltable" class="row" style="display:none;background:white;">
                                ...
                                <div class="col-sm-12" style='margin-top:10px;margin-bottom:10px;'>
                                    ...
                                    <div class="col-sm-6 eventInsForm_ledger">


                                        <input id="search_pro" onkeyup="ledger_search(this,1)"
                                               style="background: white url('<?php echo base_url(); ?>css/search.png') left center no-repeat;padding-left:35px"
                                               class="form-control">
                            ...
                            <div id="ptable" class="row" style="display:none;background:white;overflow:auto">
                                ...
                                <div class="col-sm-12" style='margin-top:10px;margin-bottom:10px;'>
                                    ...
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-6 eventInsForm">


                                        <input id="search_pro" onkeyup="search(this)"
                                               style="background: white url('<?php echo base_url(); ?>css/search.png') left center no-repeat;padding-left:35px"
                                               class="form-control">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row r_padding">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <form id="imageform" method="post" enctype="multipart/form-data"
                                                  action='<?php echo base_url(); ?>product_con/upload/'>
                                            ...
                                            <div id='preview' style="padding:5px">
                                                ...
                                                <img style='display:none' src="<?php echo base_url(); ?>img/loader.gif"
                                                     id="img">
                                    ...
                                    <div class="row r_padding">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <button type="submit" onclick="process_p()" id="submit_p"
                            ...
                            <div class="row" id="pbtn" style="display:none">
                                <div class="col-sm-12" style="text-align:right">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <button onclick="process()" id="submit_l" class="btn btn-primary">Submit
                                        </button>
                ...
                <div class="modal fade" id="head_move_modal" role="dialog">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-body">

                                <div class="row">
                                    <a href="#" title="Close"><i style="background: black;
border-radius: 10px;" onclick="CloseModal()" class="glyphicon glyphicon-remove icon-arrow-right pull-right"></i></a>
                                </div>
                                ...
                                <!--<div class="row" style="margin-top:5px;">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input class="form-control" id="cate_name">
                                ...
                                <div class="row" style="margin-top:5px;">
                                    ...
                                    <label class="col-sm-4">Move</label>
                                    <div class="col-sm-8 auto_com">
                                ...
                                <div class="row" style="margin-top:5px;">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <button class="btn btn-primary" id="cate_update">Update</button>
